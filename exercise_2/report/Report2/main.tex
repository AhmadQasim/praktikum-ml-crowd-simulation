...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.45\textwidth]{pictures/gnm/rimeatest6.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.45\textwidth]{pictures/gnm/chicken.png}
...
\begin{enumerate}
	...
	\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{pictures/task5_graphs/ped_30_2.png}
    \caption{True states and estimated states with true model as OSM and prediction model as GNM with 30 pedestrians}
    \label{fig:ped30_2}
	\end{figure}
