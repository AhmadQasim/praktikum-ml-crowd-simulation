...
\caption[]
{{\small Reconstructed image of a racoon using the first 50 principal components}}
...
\caption[]
{{\small Reconstructed image of a racoon using the first 10 principal components}}
\label{fig:task1_part2_10}
\end{subfigure}
\caption{The reconstructed images of a racoon using different numbers of principal components}
